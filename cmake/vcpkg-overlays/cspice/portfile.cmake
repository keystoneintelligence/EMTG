...
get_filename_component(EXTENSION "${SUBPATH}" EXT)
string(SUBSTRING "${SHA512}" 0 6 SHORT_SHA)
vcpkg_download_distfile(ARCHIVE
    URLS "https://naif.jpl.nasa.gov/pub/naif/misc/toolkit_N0067/C/${SUBPATH}"
    FILENAME "cspice-${SHORT_SHA}${EXTENSION}"
    SHA512 "${SHA512}")

vcpkg_extract_source_archive(SOURCE_PATH ARCHIVE "${ARCHIVE}"
    NO_REMOVE_ONE_LEVEL PATCHES isatty.patch)
file(COPY "${CMAKE_CURRENT_LIST_DIR}/CMakeLists.txt" DESTINATION "${SOURCE_PATH}")

if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    set(STATIC_BUILD ON)
endif()
vcpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}" OPTIONS -DSTATIC_BUILD=${STATIC_BUILD}
