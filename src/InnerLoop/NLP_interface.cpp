...
namespace EMTG
{
    namespace Solvers
    {
        ...
        EMTG::Solvers::NLP_interface::NLP_interface() :
            ...
            nA(0),
            NLP_start_time(0),
            mostRecentNLPWriteTime(0),
            movie_frame_count(0),
            J_NLP_incumbent(math::LARGE),
            feasibility_metric_NLP_incumbent(math::LARGE),
            feasibility_metric(math::LARGE),
            normalized_feasibility_metric(math::LARGE),
            worst_constraint(0),
            worst_decision_variable(0),
            decision_vector_feasibility_metric(math::LARGE),
            distance_from_equality_filament(math::LARGE),
            first_feasibility(false),
            newBestIncumbent(false),
            JGlobalIncumbent(math::LARGE),
