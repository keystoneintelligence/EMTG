...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|l|l|X|}
		...
		\date{April 10, 2026} & Keystone Intelligence & Added optional IPOPT build and configuration guidance for Windows.\\	 \hline
	\end{tabularx}
\end{table}
\end{titlepage}
...
\begin{itemize}
	...
	\item How to configure EMTG to build with IPOPT as the NLP backend when SNOPT is unavailable.
\end{itemize}
...
\input{../../../shared_latex_inputs/sec-prerequisites_windows.tex}
...
\input{../../../shared_latex_inputs/sec-obtaining_git_repo_public}
...
\input{../../../shared_latex_inputs/sec-dep_python}
...
\input{../../../shared_latex_inputs/sec-dep_mingw}
...
\input{../../../shared_latex_inputs/sec-dep_visual_studio}
...
\input{../../../shared_latex_inputs/sec-dep_cmake}
...
\input{../../../shared_latex_inputs/sec-dep_boost}
...
\input{../../../shared_latex_inputs/sec-dep_gsl}
...
\input{../../../shared_latex_inputs/sec-dep_cspice}
...
\input{../../../shared_latex_inputs/sec-dep_snopt}



\input{../../../shared_latex_inputs/sec-snopt_compile_windows}
...
\input{./sec-build_emtg_config_cmake_public}
...
\input{./sec-build_setting_cmake_options_public}
...
\input{../../../shared_latex_inputs/sec-build_emtg_in_visual_studio}
...
\input{../../../shared_latex_inputs/sec-pyemtg_look_elsewhere}
\input{./sec-executing_pyemtg_windows}

\subsection{Using Command Line}
\label{sec:executing_emtg_without_pyemtg}

\input{../../../shared_latex_inputs/sec-executing_emtg_without_pyemtg}
